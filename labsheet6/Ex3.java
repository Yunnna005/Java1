...
public class Ex3 {
    public static void main(String[] args) {
        ...
        displayRainfallTable(rainfall);
        displayRainfallInMonth(rainfall);
        displayWinterRainfall(rainfall);
        displayJanuaryToJuneRainfall(rainfall);
        System.exit(0);
    }
    public static void displayRainfallTable(int[] rainfall){
        String text = "";
        int i;
    ...
    public static void displayRainfallInMonth(int[] rainfall){
        int month;
    ...
    public static void displayWinterRainfall(int[] rainfall){
        int winterRainfall;
    ...
    public static void displayJanuaryToJuneRainfall(int[] rainfall){
        int janToJuneRainfall = 0;
        for (int i = 0; i<=5; i++){
